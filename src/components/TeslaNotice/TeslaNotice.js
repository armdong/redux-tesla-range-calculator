...
const TeslaNotice = () => (
  <div className="tesla-battery__notice">
    ...
    <p>
      Vehicle range may vary depending on the vehicle configuration, battery age and condition, driving style and operating, enviourmental and climate conditions.
    </p>
  </div>
)
